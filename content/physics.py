...
PLANET_TYPES = {
    ...
    # massEarth mirrors physics.js: Mars-like, on the far side of the
    # thermal water-retention boundary near 0.12 Mearth.
    "desert": dict(label="Mars-like", surfaceAlbedo=0.28, cloudFraction=0.30,
                   transportFactor=0.6, mixedLayerM=2, massEarth=0.107),
    "ocean":  dict(label="Super-Earth", surfaceAlbedo=0.09, cloudFraction=0.80,
